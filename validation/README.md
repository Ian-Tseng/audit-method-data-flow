...
- [`component-map/accepted-map.json`](component-map/accepted-map.json) is the
  exact owner-accepted map `component-map-33e16fc245a9`.
...
- [`history/20260820T172647056449Z-d3e85df4.json`](history/20260820T172647056449Z-d3e85df4.json)
  is the current append-only semantic authority.
- [`reports/20260820T172647056449Z-d3e85df4.md`](reports/20260820T172647056449Z-d3e85df4.md)
