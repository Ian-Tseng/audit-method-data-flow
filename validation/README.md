...
- [`component-map/accepted-map.json`](component-map/accepted-map.json) is the
  exact owner-accepted map `component-map-bf472206ac9c`.
...
- [`history/20260820T181728524977Z-add3a409.json`](history/20260820T181728524977Z-add3a409.json)
  is the current append-only semantic authority.
- [`reports/20260820T181728524977Z-add3a409.md`](reports/20260820T181728524977Z-add3a409.md)
